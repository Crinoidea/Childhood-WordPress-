        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('history_subtitle_1', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('history_text_1', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <?php
                            $image = get_field('history_img_1', 2);
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <?php
                            $image = get_field('history_img_2', 2);
                    ...
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('history_subtitle_2', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('history_text_2', 2); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('history_subtitle_3', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('history_text_3', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <?php
                            $image = get_field('history_img_3', 2);

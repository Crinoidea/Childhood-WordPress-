<div class="question">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('src_social_1', 2); ?>" class="footer__social-item">
                                <img src="<?php the_field('img_social_1', 2)?>" alt="social_1">
                            </a>
                            <a href="<?php the_field('src_social_2', 2); ?>" class="footer__social-item">
                                <img src="<?php the_field('img_social_2', 2)?>" alt="social_2">
                            </a>
                            <a href="<?php the_field('src_social_3', 2); ?>" class="footer__social-item">
                                <img src="<?php the_field('img_social_3', 2)?>" alt="social_3">
                            </a>
                        </div>
                    </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCRtE3xBZvI_Zhxqdxw1jPA7UycQRKx_r4"></script>
